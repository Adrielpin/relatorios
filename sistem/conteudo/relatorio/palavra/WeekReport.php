...
if($rede != 'SEARCH'){
	...
	$selector->fields = array('DayOfWeek', 'Clicks', 'Impressions', 'Cost', 'AveragePosition', 'Conversions', 'ViewThroughConversions', $parcela_impressao);
	$selector->predicates[] = new Predicate('Id', 'IN', $word);
